"""Run hard-label or teacher-completion SFT through Tinker."""
...
async def train_sft(config: SFTConfig) -> None:
    require_tinker_key()
    ...
    run_config = train.Config(
        ...
        recipe_name="calibrate_qwen_sft",
        renderer_name=config.renderer_name,
...
def main() -> None:
    ...
    asyncio.run(train_sft(SFTConfig(**vars(args))))
